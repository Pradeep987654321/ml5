...
model = joblib.load('D:/Pradeep/ml/flask_machine learning/machine-learning-tutorials-master/ml-deploy-model/deploy-with-flask/web_application/abalone_predictor.joblib')
